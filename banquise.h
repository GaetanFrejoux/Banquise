...
void fonteDesGlaces(T_case **banquise,T_joueur *tableau_joueur, int **etatBanquise, int taille,int *nombre_morts); // Fonction permettant d'appliquer la fonte des glaces du terrain FONCTION OK
